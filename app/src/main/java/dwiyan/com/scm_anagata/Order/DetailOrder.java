...
public class DetailOrder extends BaseActivity implements AdapterListItemTransaction.OnItemClickListener {
    ...
    private void SetUp() {
        ...
        btnbayar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Dialog d = new Dialog(DetailOrder.this);
                ...
                btnpaymentgateway.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent i = new Intent(DetailOrder.this, VirtualAccountActivity.class);
    ...
    private void SetUpData(String iDtrans) {
        ...
        confirmdata.enqueue(new Callback<ResponseModelConfirmasiTrans>() {
            ...
            public void onResponse(Call<ResponseModelConfirmasiTrans> call, Response<ResponseModelConfirmasiTrans> response) {
                ...
                if (Integer.parseInt(response.body().getTransactionStatusID()) == 3) {
